                                                ...
                                                <table class="em_wrapper" align="center" width="620" border="0"
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            Nogmaals bedankt voor je bestelling bij ons. Wij zijn erg benieuwd naar jou beoordeling. Wilt je zo vriendelijk zijn jou bestelling te beoordelen via de onderstaande link?
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <a
                                                            ...
                                                            style="display:inline-block; text-decoration:none; color:#FFFFFF; width:154px; background-color:#24ABFF; border-radius:8px; font-family:Arial, Tahoma; Font-size:16px; line-height:14px; font-weight:bold; font-style:normal; margin-left:20px; padding:16px 10px; text-align:center; ">{!! __('messages.review_now')  !!}</a>
                                                </td>
                                            </tr>
                                        @endif
                            ...
                            <tr>
                                <td align="center" style="padding:20px 0 35px 0">
                                    <a href="https://eatcard.nl"
                                       ...
                                       target="_blank"><img src="{{ \Weboccult\EatcardMailCompanion\Helpers\getS3File(config('eatcardMailCompanion.AWS_URL').'assets/eat_card.png') }}"
