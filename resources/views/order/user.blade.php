                                                                    ...
                                                                    @if($store->facebook_url)
                                                                        <td align="center">
                                                                            <a href="{{ $store->facebook_url }}"><img
                                                                                        class="em_img" src="{{ \Weboccult\EatcardMailCompanion\Helpers\getS3File(config ('eatcardMailCompanion.AWS_URL').'assets/facebook2.png') }}" style="display:block" width="34" height="34" border="0" alt="FB"/></a>
                                                                        </td>
                                                                    @endif
                                                                    <td width="10"></td>
