                            ...
                            <table class="em_wrapper" align="center" width="478" border="0" cellspacing="0" cellpadding="0" style="width:478px;">
                                <tr>
                                    <td align="center" style="padding:20px 0 0 0">
                                        @if($store->page_logo)
                                            <img src="{{ \Weboccult\EatcardMailCompanion\Helpers\getS3File($store->email_page_logo) }}" style="display:block"
                                                 {{--width="auto" height="80"--}} border="0" alt="Eatcard"/>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="font-family:Arial, Tahoma; font-size:18px; line-height:28px; font-weight:normal; font-style:normal; color:#000000; padding:40px 0 36px 0">
                                        ...
                                        Uw reservering voor <b>{{ $storeRes->person }} personen</b> op <b>{{ $storeRes->res_date  }}</b> om <b>{{ $storeRes->from_time }} uur</b> is door ons ontvangen.<br /><br />

                                        Wij zullen uw reservering z.s.m. bevestigen. Mocht u binnen 24 uur nog geen bevestiging ontvangen, neem dan contact op met ons via het telefoonnummer: {{$store->store_phone}}.
                                    </td>
                                </tr>
                            </table>
                            </td>
                                            ...
                                            <tr>
                                                <td align="center" style="padding:0 0 0 0">
                                                    @if($storeRes->meal->meal_image)
                                                        <img class="em_img" src="{{$storeRes->meal->meal_image}}" style="display:block" width="520" height="174" border="0" alt="Image"/>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endif
