                                ...
                                <td align="center"
                                    ...
                                    <table class="em_wrapper" align="center" width="100%" border="0" cellspacing="0"
                                        ...
                                        @if(isset($store->store_img))
                                            <tr>
                                                <td align="center" style="padding:0 0 0 0">
                                                    <img class="em_img" src="{{ Weboccult\EatcardMailCompanion\Helpers\getS3File($store->store_img) }}" style="display:block" width="698" border="0" alt="Image"/>
                                                </td>
                                            </tr>
                                        @endif
                                        <tr></tr>
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <strong style="font-family:'Roboto Slab', Arial, Tahoma;">
                                                                    We zien u graag snel weer terug</strong>
                                                            </td>
                                                        </tr>
                                ...
                                <td align="center" style="padding:20px 0 35px 0">
                                    @if($store->facebook_url)
                                        <a style="display: inline-block; padding-right: 10px" href="{{ $store->facebook_url }}"
                                           title="Facebook"
                                           target="_blank"><img src="{{ 'https://eatcard.s3.eu-central-1.amazonaws .com/assets/facebook.png' }}"
                                    ...
                                    @if($store->instagram_url)
                                        <a  style="display: inline-block; padding-right: 10px" href="{{ $store->instagram_url }}"
                                            title="Instagram"
                                            target="_blank"><img src="{{ 'https://eatcard.s3.eu-central-1.amazonaws.com/assets/instagram.png' }}" style="display:block" width="24" height="24" border="0"
                                                                 alt="Image"/></a>
                                    @endif
                                </td>
                            </tr>
