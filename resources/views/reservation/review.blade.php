                ...
                <table class="em_wrapper" align="center" width="700px" border="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center" style="padding:0 0 0 0">
                            @if($store->page_logo)
                                <img class="em_image" src="{{ \Weboccult\EatcardMailCompanion\Helpers\getS3File($store->page_logo) }}"
                                     style="display:block" {{--width="auto" height="80"--}} border="0"
                                                ...
                                                <table class="em_wrapper" align="center" width="620" border="0"
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            Hartelijk bedankt voor uw bezoek aan ons restaurant.
                                                            Wij vonden het geweldig u te mogen ontvangen
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        @if(isset($store) && isset($store->file_name))
                                            <tr>
                                                <td align="center" style="padding:0 0 0 0">
                                                    <img class="em_img" src="{{\Weboccult\EatcardMailCompanion\Helpers\getS3File($store->file_name)}}"
                                        ...
                                        @if($store->allow_review == 1)
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <a
                                                            href="{{ $review_link_url }}"
                                                            style="display:inline-block; text-decoration:none; color:#FFFFFF; width:154px; background-color:#24ABFF; border-radius:8px; font-family:Arial, Tahoma; Font-size:16px; line-height:14px; font-weight:bold; font-style:normal; margin-left:20px; padding:16px 10px; text-align:center; ">Deel je ervaring</a>
                                                </td>
                                            </tr>
                                        @endif
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <strong style="font-family:'Roboto Slab', Arial, Tahoma;">
                                                                    Hartelijk bedankt, wij kijken ernaar uit om u nogmaals te mogen ontvangen in ons restaurant.
                                                            </td>
                                                        </tr>
                            ...
                            <tr>
                                <td align="center" style="padding:20px 0 35px 0">
                                    <a href="https://eatcard.nl"
                                       title="Eatcard - Ontgrendel een krachtig systeem van services die samenwerken
                                       voor de horeca" target="_blank"><img src="{{ \Weboccult\EatcardMailCompanion\Helpers\getS3File(config('eatcardMailCompanion.AWS_URL').'assets/eatcard-email.png') }}" style="display:block" width="146" height="24" border="0" alt="Image"/></a>
                                </td>
                            </tr>
