                                                        ...
                                                        <table class="em_wrapper" align="right" width="168" border="0" cellspacing="0" cellpadding="0"  style="width:168px; background-color:#1B68AA; border-radius:4px; max-width:168px">
                                                            <tr>
                                                                <td class="em_font16" align="center" style="font-family:Ubuntu, Helvetica, Arial, sans-serif; font-size:14px; line-height:16px; font-weight:bold; font-style:normal; color:#FFFFFF; padding:8px 5px 8px 5px; ">
                                                                    <a href="" style="display:block; text-decoration:none; color:#FFFFFF">Vragen en opmerking</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                            ...
                            <table class="em_wrapper" align="center" width="478" border="0" cellspacing="0" cellpadding="0" style="width:478px;">
                                <tr>
                                    <td align="center" style="padding:20px 0 0 0">
                                        <img src="{{ isset($store->page_logo) ? Weboccult\EatcardMailCompanion\Helpers\getS3File($store->page_logo) : '' }}"
                                ...
                                <tr>
                                    <td align="left" style="font-family:Arial, Tahoma; font-size:18px; line-height:28px; font-weight:normal; font-style:normal; color:#000000; padding:40px 0 36px 0">
                                        ...
                                        Hartelijk bedankt voor uw reservering bij ons. Wij verwelkomen u en uw gezelschap op <b>{{ $storeRes->res_date }}</b> om <b>{{ $storeRes->from_time }} uur</b> graag in ons restaurant.
                                                                    ...
                                                                    <tr>
                                                                        @if($store->facebook_url)
                                                                            <td align="center">
                                                                                ...
                                                                                }}"><img class="em_img" src="{{ \Weboccult\EatcardMailCompanion\Helpers\getS3File(config('eatcardMailCompanion.AWS_URL').'assets/facebook2.png') }}" style="display:block" width="24" height="24" border="0" alt="FB" /></a>
                                                                            </td>
                                                                        @endif
                                                                        <td width="5"></td>
                                                                        @if($store->instagram_url)
                                                                            <td align="center">
                                                                                ...
                                                                                }}"><img class="em_img" src="{{ \Weboccult\EatcardMailCompanion\Helpers\getS3File(config('eatcardMailCompanion.AWS_URL').'assets/instagram.png') }}" style="display:block" width="24" height="24" border="0" alt="IG" /></a>
                                                                            </td>
                                                                        @endif
                                                                    </tr>
                                                                </table>
                                    ...
                                    <table class="em_wrapper" align="center" width="478" border="0" cellspacing="0" cellpadding="0" style="width:478px;">
                                        ...
                                        <tr>
                                            <td align="center" style="padding:10px 0 30px 0">
                                                <img src="{{ \Weboccult\EatcardMailCompanion\Helpers\getS3File(config('eatcardMailCompanion.AWS_URL').'assets/eat_card.png') }}"
                                                     style="display:block" width="56" height="25" border="0" alt="et card" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
