                            ...
                            <table class="em_wrapper" align="center" width="478" border="0" cellspacing="0" cellpadding="0" style="width:478px;">
                                <tr>
                                    <td align="center" style="padding:20px 0 0 0">
                                        @if($store->page_logo)
                                            <img src="{{ \Weboccult\EatcardMailCompanion\Helpers\getS3File($store->email_page_logo) }}" style="display:block" {{--width="auto"
                                            height="80"--}} border="0" alt="Logo"/>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <td align="center" style="padding:0 10px 0 10px">
                                    <table class="em_wrapper" align="center" width="520" border="0" cellspacing="0" cellpadding="0" style="width:520px;">
                                        ...
                                        <td class="em_wrapper2" align="right" width="142" valign="top">
                                            <table class="em_wrapper" align="right" width="100%" border="0"
                                                   cellspacing="0" cellpadding="0" style="width:100%; ">
                                                <tr>
                                                    <td class="em_wrapper2" align="left" width="370" valign="top">
                                                        <table class="em_wrapper" align="left" width="100%"
                                                    ...
                                                    @if($storeRes->qr_image != '#' &&($store->tickets_qr_enable==1 ||$store->is_reservation_tickets_enable ==1))
                                                        <td align="center" class="em_hide">
                                                            <img class="em_hide"
                                                                 src="https://eatcard.s3.eu-central-1.amazonaws.com/assets/line.png"
                                                                 style="display:block" width="2" height="230"
                                                                 border="0"
                                                                 alt="Image"/>
                                                        </td>
                                                        <td class="em_wrapper2" align="right" width="142"
                                                            valign="top">
                                                            <table class="em_wrapper" align="right" width="100%"
                                                                   border="0" cellspacing="0" cellpadding="0"
                                                                   style="width:100%; ">
                                                                <tr>
                                                                    <td align="center" style="padding:0 0 0 0; ">
                                                                        <table class="em_wrapper" align="right"
                                                                               width="100%" border="0"
                                                                               cellspacing="0"
                                                                               cellpadding="0"
                                                                               style="width:100%; background-color:#A8D5F5; border-radius:10px; box-shadow:0 0 2px 1px #F4F4F4">
                                                                            <tr>
                                                                                <td align="center"
                                                                                    style="font-family:'Work Sans', Arial, sans-serif; font-size:18px; line-height:22px; font-weight:bold; font-style:normal; color:#FFFFFF; padding:22px 0 0 0; ">
                                                                                    Scan hier
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center"
                                                                                    ...
                                                                                    <div class="qr-container"
                                                                                         style="text-align: center!important;height: 85px;width: 106px;">
                                                                                        @if($storeRes->qr_image)
                                                                                            <img
                                                                                                    src="{!! $storeRes->qr_image !!}"
                                                                            ...
                                                                            <tr>
                                                                                <td align="center"
                                                                                    ...
                                                                                    <table align="center"
                                                                                           ...
                                                                                           cellspacing="0"
                                                                                           cellpadding="0"
                                                                                           style="width:106px; background-color:#FFFFFF; border-radius:8px">
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                style="font-family:'Work Sans', Arial, sans-serif; font-size:14px; line-height:18px; font-weight:normal; font-style:normal; color:#000000; padding:5px 5px 5px 5px; ">
                                                                                                <a href=""
                                                                                                   style="text-decoration:none; color:#000000">{{ $storeRes->reservation_id }}</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                ...
                                                                <table class="em_wrapper" align="left" width="100%" border="0" cellspacing="0" cellpadding="0" style="width:100%">
                                                                    <tr>
                                                                        <td align="left" style="font-family:Arial, Tahoma; font-size:14px; line-height:17px; font-weight:normal; font-style:normal; color:#000000; padding:0 0 0 0">
                                                                            ...
                                                                            $storeRes->person
                                                                            }}x€{{\Weboccult\EatcardMailCompanion\Helpers\changePriceFormat(@$storeRes->meal->price)}})
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                ...
                                <tr>
                                    <td align="center" style="padding:0 10px 20px 10px; ">
                                        <table class="em_wrapper" align="center" width="478" border="0" cellspacing="0" cellpadding="0" style="width:478px; background-color:#F7F7F7; border-radius:12px">
                                            <tr>
                                                <td align="center" style="padding:20px 0 0 0">
                                                    <a href=""><img src="{{ config('eatcardMailCompanion.AWS_URL').'assets/btn2.png' }}" style="display:block;" width="98" height="24" border="0" alt="Opmerking"/></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                            ...
                                                            <table align="center" border="0" cellspacing="0" cellpadding="0" >
                                                                <tr>
                                                                    @if($store->facebook_url)
                                                                        <td align="center">
                                                                            <a href="{{ $store->facebook_url }}"><img class="em_img" src="{{ config('eatcardMailCompanion.AWS_URL').'assets/facebook2.png' }}" style="display:block" width="24" height="24" border="0" alt="FB"/></a>
                                                                        </td>
                                                                    @endif
                                                                    <td width="5"></td>
                                                                    @if($store->instagram_url)
                                                                        <td align="center">
                                                                            <a href="{{ $store->instagram_url }}"><img class="em_img" src="{{ config('eatcardMailCompanion.AWS_URL').'assets/instagram.png' }}" style="display:block" width="24" height="24" border="0" alt="IG"/></a>
                                                                        </td>
                                                                    @endif
                                                                </tr>
                                                            </table>
                                    ...
                                    <table class="em_wrapper" align="center" width="478" border="0" cellspacing="0" cellpadding="0" style="width:478px;">
                                        ...
                                        <tr>
                                            <td align="center" style="padding:10px 0 30px 0">
                                                <img src="{{ config('eatcardMailCompanion.AWS_URL').'assets/eat_card .png' }}" style="display:block" width="56" height="25" border="0" alt="et card"/>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
