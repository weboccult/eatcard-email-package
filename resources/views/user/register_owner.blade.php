                                                ...
                                                <table class="em_wrapper" align="center" width="620" border="0" cellspacing="0" cellpadding="0"  style="width:620px;">
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-family:'Roboto Slab', Georgia; font-size:14px; line-height:19px; font-weight:normal; font-style:normal; color:#575757; padding:28px 0 35px 0;">
                                                            Hartelijk dank voor uw vertrouwen in Eatcard. Wij hebben uw restaurant gekoppeld aan uw account. Hieronder vindt u uw account gegevens.
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-family:'Roboto Slab', Georgia; font-size:16px; line-height:21px; font-weight:bold; font-style:normal; color:#24ABFF; padding:40px 0 0 0;">
                                                            1. Integreren op uw website
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-family:'Roboto Slab', Georgia; font-size:14px; line-height:19px; font-weight:normal; font-style:normal; color:#575757; padding:4px 0 8px 0; border-bottom:1px solid #E7E7E7">
                                                            Kopieer deze code en plak in de website
                                                        </td>
                                                    </tr>

                                                    @foreach($multipleStores as $multipleStore)
                                                        <tr>
                                                            <td align="center" style="padding:20px 0 0 0">
                                                                <table class="em_wrapper" align="center" width="620" border="0" cellspacing="0" cellpadding="0"  style="width:620px; border-radius:12px; background-color:#F4F4F4">
                                                                    <tr>
                                                                        <td align="center" style="padding:20px 20px 20px 20px; ">
                                                                            <table class="em_wrapper" align="center" width="580" border="0" cellspacing="0" cellpadding="0"  style="width:580px;">
                                                                                <tr>
                                                                                    <td align="left" style="font-family:'Roboto Slab', Georgia; font-size:14px; line-height:19px; font-weight:normal; font-style:normal; color:#575757; ">
                                                                                        &lt;iframe src="{{config('app.url')}}/{{ (isset ($multipleStore)) ? $multipleStore->store_slug : '' }}/booking-frame" id="{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}-booking-iframe" allowfullscreen scrolling="no" frameborder="0" style="width: 100%;vertical-align: top;"&gt;&lt;/iframe&gt;
                                                                                        &lt;script&gt; var iframe = document.getElementById("{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}-booking-iframe");iframe.contentWindow.postMessage(['show-res-form', "{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}", window.location.href], '*');window.addEventListener("message", function (e) {if (e.data[0] === "booking-redirect-url") {window.location.href = e.data[1];}if (e.data[0] === "{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}") {document.getElementById("{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}-booking-iframe").style.height = e.data[1] + "px"}if (e.data[0] === "booking-frame-open") {iframe.contentWindow.postMessage(['show-res-form', "{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}", window.location.href], '*');}}, false);&lt;/script&gt;
                                                                                        {{--                                                                                    &lt;iframe src="https://app.eatcard.nl/{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}/booking-frame" id="{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}" allowfullscreen scrolling="no" frameborder="0" style="width: 100%;vertical-align: top;"&gt;&lt;/iframe&gt;--}}
                                                                                        {{--                                                                                    &lt;script&gt; window.addEventListener("message", function(e){if(e.data[0]==="{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}"){document.getElementById("{{ (isset($multipleStore)) ? $multipleStore->store_slug : '' }}").style.height=e.data[1]+"px"}},false); &lt;/script&gt;--}}
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-family:'Roboto Slab', Georgia; font-size:16px; line-height:21px; font-weight:bold; font-style:normal; color:#24ABFF; padding:30px 0 8px 0; border-bottom:1px solid #E7E7E7">
                                                            Enkele tips voor een perfecte integratie
                                                        </td>
                                                    </tr>
                                                            ...
                                                            <table class="em_wrapper" align="left" border="0" width="100%" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" valign="top"  style="font-family:'Roboto Slab', Georgia; font-size:14px; line-height:24px; font-weight:normal; font-style:normal; color:#575757; padding: 0  0; ">
                                                                        Stel uw arrangementen en tijdsloten in. <a
                                                                                href="{{$link}}">Klik hier</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        ...
                                                        <td align="left" style="padding:0 0 0 0">
                                                            <table class="em_wrapper" align="left" border="0" width="100%" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" valign="top"  style="font-family:'Roboto Slab', Georgia; font-size:14px; line-height:24px; font-weight:normal; font-style:normal; color:#575757; padding: 0  0; ">
                                                                        Test de mobiele weergave of het goed functioneert.
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        ...
                                                        <td align="left" style="padding:0 0 0 0">
                                                            <table class="em_wrapper" align="left" border="0" width="100%" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" valign="top"  style="font-family:'Roboto Slab', Georgia; font-size:14px; line-height:24px; font-weight:normal; font-style:normal; color:#575757; padding: 0  0; ">
                                                                        Doorloop het volledige reserveringsproces om eventuele fouten op te merken
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
